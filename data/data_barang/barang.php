...
<div class="content">
            ...
            <div class="box-header">
			 <div class="box-header">
              <div class="text-center">
				<h1>Data Kategori Brand</h1>
				<hr>
            </div>
              <a href="?page=barang&aksi=tambah"><button type="button" class="btn btn-primary"><i class="fa fa-plus"> </i> Tambah Brand</button></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <thead>
    <tr>
      ...
      <th scope="col" class="text-center">Id Kategori Brand</th>
