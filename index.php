...
<head>
  ...
  <title>PT Fatahillah Anugerah NBRS</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b></b>NBRS</span>
    </a>
...
?>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="?page=barang"><i class="fa fa-link"></i> <span>Data Kategori Brand</span></a></li>
		<li><a href="?page=nabar"><i class="fa fa-link"></i> <span>Data Barang</span></a></li>
		<li><a href="?page=costumer"><i class="fa fa-link"></i> <span>Data Distributor</span></a></li>
		<li><a href="?page=kirim"><i class="fa fa-link"></i> <span>Dashboard Pengiriman</span></a></li>
  ...
  <footer class="main-footer">
	...
	https://www.nbrscorp.co.id
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2023 <a href="#">PT Fatahillah Anugerah NBRS</a>.</strong> All rights reserved.
  </footer>
